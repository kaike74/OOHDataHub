        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
            ...
            <div className="absolute inset-y-0 right-0 w-1/2 overflow-hidden pointer-events-none">
                <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <defs>
                        {/* Pink gradient for signal pulse - softer opacity */}
                        <linearGradient id="signalPulse" x1="100%" y1="0%" x2="0%" y2="0%">
                            <stop offset="0%" stopColor="rgba(252, 30, 117, 0.5)" />
                            <stop offset="20%" stopColor="rgba(252, 30, 117, 0.4)" />
                            <stop offset="50%" stopColor="rgba(252, 30, 117, 0.25)" />
                            <stop offset="100%" stopColor="rgba(252, 30, 117, 0)" />
                        </linearGradient>

                        {/* Subtle cable color */}
                        <linearGradient id="cableGradient" x1="100%" y1="0%" x2="0%" y2="0%">
                            <stop offset="0%" stopColor="rgba(106, 13, 173, 0.06)" />
                            <stop offset="50%" stopColor="rgba(106, 13, 173, 0.04)" />

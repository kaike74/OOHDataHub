...
import { LogOut, FileText, Calendar, BarChart3, Target, ExternalLink, Building2 } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="h-8 w-8 bg-emidias-primary rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-md shadow-emidias-primary/20">
                            ODH
                        </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white rounded-2xl p-12 text-center border border-gray-100 shadow-sm animate-in fade-in zoom-in duration-500">
                    ...
                    <div className="space-y-12 animate-in fade-in-up duration-500">
                        {Object.entries(
                            ...
                            <div key={clientId} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                                ...
                                <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                                    <div className="flex items-center gap-3">
                                        <div className="h-10 w-10 bg-white rounded-lg border border-gray-200 flex items-center justify-center text-gray-400 font-bold overflow-hidden shadow-sm relative">
                                            {group.clientLogo ? (
                                                <SafeImage
                                                    src={api.getImageUrl(group.clientLogo)}
                                    ...
                                    <table className="w-full">
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            {group.proposals.map((proposal) => (
                                                <tr
                                                    key={proposal.id}
                                                    className="hover:bg-emidias-primary/5 transition-colors cursor-pointer group"

...
export default function PriorityCard({
    ...
    const priorityStyles = {
        ...
        medium: "border-emidias-accent/20 bg-white shadow-sm hover:shadow-md hover:border-emidias-accent/40",
    ...
    const highPriorityOverlay = priority === 'high' ? (
        <div className="absolute top-0 left-0 w-1 bg-gradient-to-b from-emidias-accent to-emidias-primary h-full" />
    ) : null;

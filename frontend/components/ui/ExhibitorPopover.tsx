...
// Simple custom implementation since we lack @floating-ui/react and @radix-ui/react-popover
    ...
    return (
        ...
        >
            <div
                ...
                onClick={(e) => {
                    e.stopPropagation();
                    setIsOpen(!isOpen); // Toggle for mobile/click support
            ...
            {isOpen && (
                <div
                    className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-100 p-4 z-[50] animate-in fade-in zoom-in-95 duration-200"
